...
if __name__ == "__main__":
    ...
    print("--LOG-- Generator created")
    img,lab = next(generator)
    print("--LOG-- Sample generated")
    print(img.shape, lab.shape)

    assert img.shape == (256,256,256), "--Log-- Wrong shape"
    assert lab.shape == (256,256,256), "--Log-- Wrong shape"
